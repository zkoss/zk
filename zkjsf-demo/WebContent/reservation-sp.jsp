		...
		<h:form id="form1">
			<h:panelGrid columns="1" >
				...
				<z:listbox id="room" mold="select" onSelect="changeRoom(self)"
					f_value="#{ReservationBean.room}"
					f_validator="#{ReservationBean.validateRoom}">
				...
				<h:panelGrid columns="3" style="border:solid 1px">
					...
					<z:textbox id="eid"  f_required="true" f_value="#{ReservationBean.eid}" onChange="eidChange()"/>
					<h:message style="color: red; font-style: oblique;" for="eid" />
					
					<h:outputText styleClass="title" value="*You Name:" />
					<z:textbox id="name" f_value="#{ReservationBean.name}" f_required="true"/>
					<h:message style="color: red; font-style: oblique;" for="name" />
					
					<h:outputText styleClass="title" value="*Date to reserve:" />
					
					<z:datebox id="date" format="yyyy/MM/dd" f_required="true" f_value="#{ReservationBean.resvDate}"/>
					...
					<z:listbox id="time" mold="select" f_required="true" f_value="#{ReservationBean.resvTime}">
					...
					<z:textbox id="phoneext" f_value="#{ReservationBean.contactPhone}" />

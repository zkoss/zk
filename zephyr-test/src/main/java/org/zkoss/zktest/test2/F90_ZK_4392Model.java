...
public class F90_ZK_4392Model extends DefaultTreeModel<String> {
	...
	public static TreeNode<String> buildStaticModel(String data) {
		DefaultTreeNode<String> root = node("", node(data + "-1", node(data + "-1-1", node(data + "-1-1-1"), node(data + "-1-1-2"), node(data + "-1-1-3")), node(data + "-1-2", node(data + "-1-2-1"), node(data + "-1-2-2"), node(data + "-1-2-3")), node(data + "-1-3", node(data + "-1-3-1"), node(data + "-1-3-2"), node(data + "-1-3-3"))), node(data + "-2loooooooooooooooooong", node(data + "-2-1"), node(data + "-2-2"), node(data + "-2-3")), node(data + "-3", node(data + "-3-1"), node(data + "-3-2"), node(data + "-3-3")), node(data + "-4"), node(data + "-5"), node(data + "-6"), node(data + "-7"), node(data + "-8"));
		return root;
	}

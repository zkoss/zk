...
public class IARichlet implements StatelessRichlet {
	...
	public IComponent dir() {
		return IVlayout.of(
				...
				IA.of("normal").withImage("/zephyr/ZK-Logo.gif").withDir("normal").withId("ia"),
				IA.of("reverse").withImage("/zephyr/ZK-Logo.gif").withDir("reverse")
		);
	}
	...
	public IComponent dir2() {
		return IVlayout.of(
				IA.of("normal").withImage("/zephyr/ZK-Logo.gif").withDir(IA.Direction.NORMAL),
				IA.of("reverse").withImage("/zephyr/ZK-Logo.gif").withDir(IA.Direction.REVERSE)
		);
	}
	...
	public IComponent target() {
		return IVlayout.of(
				...
				IA.of("target").withHref("/zephyr/ZK-Logo.gif").withTarget("_blank").withId("ia")
		);
	}
	...
	public IComponent target2() {
		return IA.of("target").withHref("/zephyr/ZK-Logo.gif").withTarget(IA.Target.BLANK);
	}

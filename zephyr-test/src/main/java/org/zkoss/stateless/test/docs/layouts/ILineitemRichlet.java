...
import org.zkoss.statelessex.sul.ILinelayout;
import org.zkoss.zk.ui.event.Events;

/**
 * A set of example for {@link org.zkoss.statelessex.sul.ILineitem} Java Docs.
...
public class ILineitemRichlet implements StatelessRichlet {
	...
	public List<IComponent> pointImageSrc() {
		return Arrays.asList(
				ILinelayout.of(ILineitem.ofId("item").withPointImageSrc("/stateless/ZK-Logo.gif")),
	...
	public void changePointImageSrc() {
		UiAgent.getCurrent().smartUpdate(Locator.ofId("item"), new ILineitem.Updater().pointImageSrc("/zephyr-test/stateless/ZK-Logo-old.gif"));
	}

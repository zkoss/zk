...
public class IButtonRichlet implements StatelessRichlet {
	...
	public List<IComponent> dir() {
		return Arrays.asList(
				IButton.ofId("btn").withDir(IButtonBase.Direction.REVERSE).withImage("/stateless/ZK-Logo.gif"),
	...
	public List<IComponent> orient() {
		return Arrays.asList(
				IButton.of("btn", "/stateless/ZK-Logo.gif").withId("btn").withOrient(IButtonBase.Orient.VERTICAL),

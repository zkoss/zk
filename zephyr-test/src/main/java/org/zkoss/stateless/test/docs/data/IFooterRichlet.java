...
public class IFooterRichlet implements StatelessRichlet {
	...
	public List<IComponent> image() {
		return Arrays.asList(
				IGrid.DEFAULT.withFoot(IFoot.of(
						IFooter.ofImage("/stateless/ZK-Logo.gif").withId("footer"))),
	...
	public void changeImage() {
		UiAgent.getCurrent().smartUpdate(Locator.ofId("footer"), new IFooter.Updater().image("/zephyr-test/stateless/ZK-Logo-old.gif"));
	}

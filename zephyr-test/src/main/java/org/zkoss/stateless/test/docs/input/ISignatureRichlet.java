...
import org.zkoss.statelessex.sul.ISignature;
import org.zkoss.zk.ui.event.Events;

/**
 * A set of example for {@link org.zkoss.statelessex.sul.ISignature} Java Docs.
...
public class ISignatureRichlet implements StatelessRichlet {
	...
	public List<IComponent> backgroundImage() {
		return Arrays.asList(
				init().withBackgroundImage("/zephyr-test/stateless/ZK-Logo-old.gif"),
	...
	public void changeBackgroundImage() {
		UiAgent.getCurrent().smartUpdate(Locator.ofId("signature"), new ISignature.Updater()
				.backgroundImage("/zephyr-test/stateless/ZK-Logo.gif"));
	}

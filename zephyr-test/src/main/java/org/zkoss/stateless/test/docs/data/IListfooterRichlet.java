...
public class IListfooterRichlet implements StatelessRichlet {
	...
	public List<IComponent> image() {
		return Arrays.asList(
				IListbox.DEFAULT.withListfoot(IListfoot.of(
						IListfooter.ofImage("/stateless/ZK-Logo.gif").withId("footer"))),
	...
	public void changeImage() {
		UiAgent.getCurrent().smartUpdate(Locator.ofId("footer"), new IListfooter.Updater().image("/zephyr-test/stateless/ZK-Logo-old.gif"));
	}

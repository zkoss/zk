...
public class ContextParamVM {
	...
	@AfterCompose
	public void init(@ContextParam(ContextType.EXECUTION) Execution execution, @ContextParam(ContextType.COMPONENT) Component component, @ContextParam(ContextType.VIEW) Component view, @ContextParam(ContextType.SPACE_OWNER) IdSpace spaceOwner, @ContextParam(ContextType.PAGE) Page page, @ContextParam(ContextType.DESKTOP) Desktop desktop, @ContextParam(ContextType.SESSION) Session session, @ContextParam(ContextType.APPLICATION) WebApp application,

					 @ContextParam(ContextType.BIND_CONTEXT) BindContext bindContext, @ContextParam(ContextType.BINDER) Binder binder) {
	...
	@NotifyChange("*")
	@Command
	public void cmd1(@ContextParam(ContextType.EXECUTION) Execution execution, @ContextParam(ContextType.COMPONENT) Component component, @ContextParam(ContextType.SPACE_OWNER) IdSpace spaceOwner, @ContextParam(ContextType.PAGE) Page page, @ContextParam(ContextType.DESKTOP) Desktop desktop, @ContextParam(ContextType.SESSION) Session session, @ContextParam(ContextType.APPLICATION) WebApp application, @ContextParam(ContextType.VIEW) Component view, @ContextParam(ContextType.BIND_CONTEXT) BindContext bindContext, @ContextParam(ContextType.BINDER) Binder binder) {
		this.applicationScope = (String) application.getAttribute("applicationScopeVar");
		this.sessionScope = (String) session.getAttribute("sessionScopeVar");
		this.desktopScope = (String) desktop.getAttribute("desktopScopeVar");
		this.pageScope = (String) page.getAttribute("pageScopeVar");
	...
	@NotifyChange("*")
	@Command
	public void cmd2(@ContextParam(ContextType.COMPONENT) Component component, @ScopeParam("applicationScopeVar") String applicationScope, @ScopeParam("sessionScopeVar") String sessionScope, @ContextParam(ContextType.VIEW) Component view, @ContextParam(ContextType.SPACE_OWNER) IdSpace spaceOwner) {
		this.applicationScope = applicationScope;
		this.sessionScope = sessionScope;
		this.bindComponentId = component.getId();
		this.bindViewId = view.getId();
	...
	@NotifyChange("*")
	@Command
	public void cmd3(@ContextParam(ContextType.COMPONENT) Component component, @ScopeParam(value = "applicationScopeVar", scopes = Scope.APPLICATION) String applicationScope, @ContextParam(ContextType.VIEW) Component view, @ScopeParam(value = "sessionScopeVar", scopes = Scope.SESSION) String sessionScope) {
		this.applicationScope = applicationScope;
		this.sessionScope = sessionScope;
		this.bindComponentId = component.getId();
		this.bindViewId = view.getId();

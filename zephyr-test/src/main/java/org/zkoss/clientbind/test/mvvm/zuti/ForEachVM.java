 ...
 */
package org.zkoss.clientbind.test.mvvm.zuti;
...
import org.zkoss.clientbind.test.mvvm.zuti.bean.Person;
...
public class ForEachVM {
	...
	public void setDataList(List array) {
		list = array;
	}
	...
	public Converter getConcatConverter() {
		return concat;
	}

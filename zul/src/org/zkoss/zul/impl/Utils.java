...
public class Utils {
	...
	public static final String outLocaleJavaScript() {
		...
		addLocaleJS(sb, "COLORBOX_COLOR_H", MZul.COLORBOX_COLOR_H);
		addLocaleJS(sb, "COLORBOX_COLOR_S", MZul.COLORBOX_COLOR_S);
		addLocaleJS(sb, "COLORBOX_COLOR_V", MZul.COLORBOX_COLOR_V);

...
public class Utils {
	...
	public static final String outLocaleJavaScript() {
		...
		addLocaleJS(sb, "PDFVIEWER_ROTATE_RIGHT", MZul.PDFVIEWER_ROTATE_RIGHT);
		addLocaleJS(sb, "PDFVIEWER_ROTATE_LEFT", MZul.PDFVIEWER_ROTATE_LEFT);
		addLocaleJS(sb, "PDFVIEWER_ZOOM_IN", MZul.PDFVIEWER_ZOOM_IN);
		addLocaleJS(sb, "PDFVIEWER_ZOOM_OUT", MZul.PDFVIEWER_ZOOM_OUT);
		addLocaleJS(sb, "PDFVIEWER_ZOOM_LEVEL", MZul.PDFVIEWER_ZOOM_LEVEL);
		addLocaleJS(sb, "PDFVIEWER_ZOOM_FIT_WIDTH", MZul.PDFVIEWER_ZOOM_FIT_WIDTH);
		addLocaleJS(sb, "PDFVIEWER_ZOOM_FIT_HEIGHT", MZul.PDFVIEWER_ZOOM_FIT_HEIGHT);
		...
		addLocaleJS(sb, "COLORBOX_COLOR_PALETTE", MZul.COLORBOX_COLOR_PALETTE);
		addLocaleJS(sb, "COLORBOX_COLOR_PICKER", MZul.COLORBOX_COLOR_PICKER);
		addLocaleJS(sb, "COLORBOX_COLOR_R", MZul.COLORBOX_COLOR_R);
		addLocaleJS(sb, "COLORBOX_COLOR_G", MZul.COLORBOX_COLOR_G);
		addLocaleJS(sb, "COLORBOX_COLOR_B", MZul.COLORBOX_COLOR_B);
		addLocaleJS(sb, "COLORBOX_HUE", MZul.COLORBOX_HUE);
		addLocaleJS(sb, "COLORBOX_SATURATION", MZul.COLORBOX_SATURATION);
		addLocaleJS(sb, "COLORBOX_VALUE", MZul.COLORBOX_VALUE);
		addLocaleJS(sb, "COLORBOX_COLOR_HEX", MZul.COLORBOX_COLOR_HEX);
		addLocaleJS(sb, "COLORBOX_COLOR_FIELD", MZul.COLORBOX_COLOR_FIELD);
		...
		addLocaleJS(sb, "COLORBOX_CURRENT_COLOR", MZul.COLORBOX_CURRENT_COLOR);

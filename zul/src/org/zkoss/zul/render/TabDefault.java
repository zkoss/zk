...
<tr>
	...
	public void render(Component comp, Writer out) throws IOException {
		...
		wh.write("<td id=\"" + self.getUuid() + "\" z.type=\"Tab\"" + self.getOuterAttrs() + self.getInnerAttrs()
		...
		wh.write("<tr>");		
		wh.write("<td class=\"" + StringFns.cat("tab-3d-tl",suffix) + "\"></td>");
		wh.write("<td colspan=\"" + colspan + "\" class=\"" + StringFns.cat("tab-3d-tm",suffix) + "\"></td>");
		wh.write("<td class=\"" + StringFns.cat("tab-3d-tr",suffix) + "\"></td>");
		wh.write("</tr>");		

		wh.write("<tr height=\"" + height + "\">");		
		wh.write("<td class=\"" + StringFns.cat("tab-3d-ml",suffix) + "\"></td>");
		wh.write("<td width=\"3\" class=\"" + StringFns.cat("tab-3d-mm",suffix) + "\"></td>");
		wh.write("<td align=\"center\" class=\"" + StringFns.cat("tab-3d-mm",suffix) + "\"><a href=\"javascript:;\"" +
				" id=\"" + self.getUuid() + "!a\">");
		...
		if(self.isClosable()){
			wh.write("<td align=\"right\" class=\"" + StringFns.cat("tab-3d-mm",suffix) + 
				"\"><img id=\""+ self.getUuid() + "!close\" src=\"" + exec.encodeURL("~./zul/img/close-off.gif") + "\"/></td>");
		}
		wh.write("<td width=\"3\" class=\"" + StringFns.cat("tab-3d-mm",suffix) + "\"></td>");	
		wh.write("<td class=\"" + StringFns.cat("tab-3d-mr",suffix) + "\"></td>");
		wh.write("</tr>");

		wh.write("<tr>");		
		wh.write("<td class=\"" + StringFns.cat("tab-3d-bl",suffix) + "\"></td>");
		wh.write("<td colspan=\"" + colspan + "\" class=\"" + StringFns.cat("tab-3d-bm",suffix) + "\"></td>");
		wh.write("<td class=\"" + StringFns.cat("tab-3d-br",suffix) + "\"></td>");
		wh.write("</tr>");
		wh.write("</table></td>");
	}

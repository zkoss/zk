 ...
 *
 * <p>Unlike {@link Html}, the output is generated directly without
 * HTML SPAN. Thus, it is more flexible to mix HTML tags. For example,
 * 
 * <pre><code>&lt;inline&gt;&lt;![CDATA[
 * &lt;table&gt;
 *  &lt;tr&gt;
 *   &lt;td&gt;
 *]]&gt;&lt;/inline&gt;
 ...
 *]]&gt;&lt;/inline&gt;</code></pre>
 *
 * <p>However, since the content is sent to client directly, {@link Inline}

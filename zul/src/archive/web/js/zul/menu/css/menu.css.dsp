...
.z-menubar-hor,.z-menubar-ver {
	...
	background-image: url(${c:encodeThemeURL('~./${theme}/zul/img/menu/menu-bg.png', theme)});
}
.z-menubar-ver {
...
.z-menubar-hor .z-menu-body-clk .z-menu-inner-m  div {
	...
	background-image: url(${c:encodeThemeURL('~./${theme}/zul/img/menu/btn-arrow.gif', theme)});
}
.z-menubar-hor .z-menu-body-clk .z-menu-inner-m  div,
...
.z-menu-item-body-over .z-menu-item-inner-r {
	...
	background-image: url(${c:encodeThemeURL('~./${theme}/zul/img/menu/menu-btn.png', theme)});
}
.z-menu-body-over .z-menu-inner-r,
.z-menu-item-body-over .z-menu-item-inner-r {
...
.z-menubar-hor .z-menu-body-clk-over .z-menu-inner-m  div {
	...
	background-image: url(${c:encodeThemeURL('~./${theme}/zul/img/menu/btn-menu-hor-over.gif', theme)});
}
.z-menubar-ver .z-menu-body-clk-over .z-menu-inner-m  div {
	background: transparent no-repeat right 0;
	background-image: url(${c:encodeThemeURL('~./${theme}/zul/img/menu/btn-menu-ver-over.gif', theme)});
}
<%-- seld effect --%>
.z-menu-body-seld .z-menu-inner-l,
.z-menu-body-seld .z-menu-inner-r {
	background:  url(${c:encodeThemeURL('~./${theme}/zul/img/menu/menu-btn.png', theme)}) no-repeat transparent 0 -120px;
}
.z-menu-body-seld .z-menu-inner-r {
...
.z-menu-popup .z-menu-popup-cnt{
	...
	background-image: url(${c:encodeThemeURL('~./${theme}/zul/img/menu/pp-bg.png', theme)});
	border:0 none;
	padding:0;
	margin:0 !important;
	overflow:hidden;
...
.z-menu-popup-cnt .z-menu .z-menu-cnt-img {
	...
	background-image: url(${c:encodeThemeURL('~./${theme}/zul/img/menu/arrow.gif', theme)});
}
<%--define checked menuitem effect in menupopup --%>
.z-menu-popup-cnt .z-menu-item-cnt-ck .z-menu-item-img {
	background:transparent no-repeat center center;
	background-image: url(${c:encodeThemeURL('~./${theme}/zul/img/menu/checked.gif', theme)});
}
.z-menu-popup-cnt .z-menu-item-cnt-unck .z-menu-item-img {
	background:transparent no-repeat center center;
	background-image: url(${c:encodeThemeURL('~./${theme}/zul/img/menu/unchecked.gif', theme)});
}

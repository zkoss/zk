...
.z-panel-br {
	...
	background-image: url(${c:encodeThemeURL('~./${theme}/zul/img/wnd/panel-corner.png', theme)});
	margin-right: 7px;
	height: 7px;
	font-size: 0;
	line-height: 0;
...
.z-panel-tr-gray {
	...
	background-image: url(${c:encodeThemeURL('~./${theme}/zul/img/wnd/panel-corner-blue.png', theme)});
}
.z-panel-bl {
...
.z-panel-header {
	...
	background-image: url(${c:encodeThemeURL('~./${theme}/zul/img/wnd/panel-hm.png', theme)});
...
.z-panel-hl {
	...
	background-image: url(${c:encodeThemeURL('~./${theme}/zul/img/wnd/panel-hl.png', theme)});
	padding-left: 7px;
...
.z-panel-hr {
	...
	background-image: url(${c:encodeThemeURL('~./${theme}/zul/img/wnd/panel-hr.png', theme)});
	padding-right: 7px;
	zoom: 1;
}
<%-- Header Middle --%>
...
.z-panel-fl {
	...
	background-image: url(${c:encodeThemeURL('~./${theme}/zul/img/wnd/panel-clr.png', theme)});
	padding-left: 4px;
	zoom: 1;
}
...
.z-panel-bl,
.z-panel-br {
	background-image: url(${c:encodeThemeURL('~./${theme}/zul/img/wnd/panel-corner.gif', theme)});
}
.z-panel-tl-gray,
.z-panel-tr-gray{
	background-image: url(${c:encodeThemeURL('~./${theme}/zul/img/wnd/panel-corner-blue.gif', theme)});
}
.z-panel-icon {

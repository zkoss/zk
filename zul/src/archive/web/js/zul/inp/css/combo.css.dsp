...
.z-combobox-rounded-inp {
	background-image: url(${c:encodeThemeURL('~./${theme}/zul/img/button/combobox-rounded.png', theme)});
}
.z-bandbox-rounded-inp {
	background-image: url(${c:encodeThemeURL('~./${theme}/zul/img/button/bandbox-rounded.png', theme)});
}
.z-datebox-rounded-inp {
	background-image: url(${c:encodeThemeURL('~./${theme}/zul/img/button/datebox-rounded.png', theme)});
}
.z-timebox-rounded-inp,
.z-spinner-rounded-inp,
.z-doublespinner-rounded-inp {
...
.z-doublespinner-rounded input.z-doublespinner-rounded-text-invalid {
	background: #FFF url(${c:encodeThemeURL('~./${theme}/zul/img/button/redcombo-rounded.gif', theme)}) repeat-x 0 0;
}
...
.z-doublespinner .z-doublespinner-btn {
	...
	background-image: url(${c:encodeThemeURL('~./${theme}/zul/img/input/combobtn.gif', theme)});
	vertical-align: top; 
	cursor: pointer; 
	width: 19px; 
	height: 20px; 
...
.z-spinner .z-spinner-btn-upper,
.z-doublespinner .z-doublespinner-btn-upper {
	background-image: url(${c:encodeThemeURL('~./${theme}/zul/img/input/timebtn-up.gif', theme)});
...
.z-spinner .z-spinner-btn-lower,
.z-doublespinner .z-doublespinner-btn-lower {
	background-image: url(${c:encodeThemeURL('~./${theme}/zul/img/input/timebtn-down.gif', theme)});
...
<%-- Bandbox trendy mold --%>
.z-bandbox .z-bandbox-btn {
	background-image: url(${c:encodeThemeURL('~./${theme}/zul/img/input/bandbtn.gif', theme)});
}
<%-- Datebox --%>
...
.z-datebox .z-datebox-btn {
	background-image: url(${c:encodeThemeURL('~./${theme}/zul/img/input/datebtn.gif', theme)});
}
.z-datebox-rounded-pp,
.z-datebox-pp {
...
.z-combobox-rounded .z-combobox-rounded-btn,
.z-combobox-rounded-readonly {
	background-image: url(${c:encodeThemeURL('~./${theme}/zul/img/button/combobox-rounded.gif', theme)});
}
.z-bandbox-rounded-inp,
.z-bandbox-rounded .z-bandbox-rounded-btn,
.z-bandbox-rounded-readonly {
	background-image: url(${c:encodeThemeURL('~./${theme}/zul/img/button/bandbox-rounded.gif', theme)});
}
.z-datebox-rounded-inp,
.z-datebox-rounded .z-datebox-rounded-btn,
.z-datebox-rounded-readonly {
	background-image: url(${c:encodeThemeURL('~./${theme}/zul/img/button/datebox-rounded.gif', theme)});
}
.z-timebox-rounded-inp,
.z-spinner-rounded-inp,
.z-doublespinner-rounded-inp,
...
.z-spinner-rounded-readonly,
.z-doublespinner-rounded-readonly {
	background-image: url(${c:encodeThemeURL('~./${theme}/zul/img/button/timebox-rounded.gif', theme)});	
}
</c:if>
<%-- Gecko --%>

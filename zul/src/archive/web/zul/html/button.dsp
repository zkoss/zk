...
<input type="button" id="${self.uuid}" zk_type="zul.widget.Button" value="${self.label}"${self.outerAttrs}${self.innerAttrs}/>
</c:when>
<c:otherwise>
<button type="button" id="${self.uuid}" zk_type="zul.widget.Button"${self.outerAttrs}${self.innerAttrs}>
<c:choose>

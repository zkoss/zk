...
<td>
<table id="${tab.uuid}" zk_sel="${tab.selected}" zk_type="zul.tab.Tab" zk_box="${tab.tabbox.uuid}" zk_panel="${tab.linkedPanel.uuid}" width="100%" border="0" cellpadding="0" cellspacing="0">

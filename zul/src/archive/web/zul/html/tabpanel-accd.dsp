...
<td>
<table id="${tab.uuid}"${tab.outerAttrs}${tab.innerAttrs} z:sel="${tab.selected}" z:type="zul.tab.Tab" z:box="${tab.tabbox.uuid}" z:panel="${tab.linkedPanel.uuid}" width="100%" border="0" cellpadding="0" cellspacing="0">

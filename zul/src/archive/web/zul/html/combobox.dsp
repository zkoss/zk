...
<span id="${self.uuid}"${self.outerAttrs} zk_type="zul.html.cb.Cmbox" zk_combo="true"><input id="${self.uuid}!real" autocomplete="off"${self.innerAttrs}/><h:img id="${self.uuid}!btn" src="~./zul/img/combobtn.gif"/><div id="${self.uuid}!pp" class="comboboxpp" style="display:none" tabindex="-1">

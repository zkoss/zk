...
<tr>
	...
	<td colspan="3" class="${c:cat3(tscls,'tm',suffix)}"></td>
	<td class="${c:cat3(tscls,'tr',suffix)}"></td>
</tr>
<tr height="22">
	<td class="${c:cat3(tscls,'ml',suffix)}"></td>
	<td width="3" class="${c:cat3(tscls,'mm',suffix)}"></td>
	<td align="center" class="${c:cat3(tscls,'mm',suffix)}" id="${self.uuid}!real"${self.innerAttrs}><a href="javascript:;" id="${self.uuid}!a">${self.imgTag}<c:out value="${self.label}"/></a></td>
	<td width="3" class="${c:cat3(tscls,'mm',suffix)}"></td>
...
<tr height="8">
	<td class="${c:cat3(tscls,'ml',suffix)}"></td>
	<td width="3" class="${c:cat3(tscls,'mm',suffix)}"></td>
	<td align="center" valign="bottom" class="${c:cat3(tscls,'mm',suffix)}"><img id="${self.uuid}!close" src="${c:encodeURL('~./zul/img/close-off.gif')}"/></td>
	<td width="3" class="${c:cat3(tscls,'mm',suffix)}"></td>
	<td class="${c:cat3(tscls,'mr',suffix)}"></td>
</tr>
</c:if>
<tr>
	...
	<td colspan="3" class="${c:cat3(tscls,'bm',suffix)}"></td>

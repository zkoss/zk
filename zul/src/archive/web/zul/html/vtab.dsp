...
<tr>
	<td width="5" height="5" class="${c:cat('tab-v3d-tl',suffix)}"></td>
	<td colspan="3" height="5" class="${c:cat('tab-v3d-tm',suffix)}"></td>
	<td width="3" height="5" class="${c:cat('tab-v3d-tr',suffix)}"></td>
</tr>
<tr height="22">
	<td width="5" class="${c:cat('tab-v3d-ml',suffix)}"></td>
	...
	<td width="3" class="${c:cat('tab-v3d-mm',suffix)}"></td>
	<td width="3" class="${c:cat('tab-v3d-mr',suffix)}"></td>
</tr>
...
<tr>
	<td width="5" height="3" class="${c:cat('tab-v3d-bl',suffix)}"></td>
	<td colspan="3" height="5" class="${c:cat('tab-v3d-bm',suffix)}"></td>
	<td width="3" height="5" class="${c:cat('tab-v3d-br',suffix)}"></td>
</tr>
</table></td>
</tr>
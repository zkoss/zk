...
<div class="${zcls}-tl${noborder}"><div class="${zcls}-tr${noborder}"><div class="${zcls}-tm${noborder}">
...
<div class="${zcls}-tl${noborder}"><div class="${zcls}-tr${noborder}"><div class="${zcls}-tm${noborder}-noheader"></div></div></div>
</c:when>
</c:choose>
...
<div id="${self.uuid}!cave" class="${self.contentSclass} ${zcls}-cnt${noborder}"${c:attr('style',wcExtStyle)}>
...
<div class="${zcls}-bl${noborder}"><div class="${zcls}-br${noborder}"><div class="${zcls}-bm${noborder}"></div></div></div>
</c:if>
</div>
</div>

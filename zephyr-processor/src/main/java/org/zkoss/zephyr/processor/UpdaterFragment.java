...
public class UpdaterFragment extends org.immutables.generator.Templates.Fragment {
	...
	private void writeImports(Templates.Invokation __) {
		boolean isZephyrEx = ((ValueType) __.param(0)).$$package().contains("zephyrex");
		...
		__.out("import org.zkoss.zephyr.ui.SmartUpdater;").ln();
		if (isZephyrEx)
			__.out("import org.zkoss.zephyr.zpr.IComponent;").ln();

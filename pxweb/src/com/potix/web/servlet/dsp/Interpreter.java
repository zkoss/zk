...
{{IS_NOTE
	$Id: Interpreter.java,v 1.19 2006/03/09 08:40:17 tomyeh Exp $
	Purpose:
		
	Description:
		
	History:
		Mon Sep  5 11:12:47     2005, Created by tomyeh@potix.com
}}IS_NOTE
...
/**
 * The interpreter of the PSP file.
 *
 * <p>Note: we recognize only <%, <\%, %>, %\>, ${ and $\{.
 * Unlike JSP, we don't recognize \${ or \$\{.
 *
 * @author <a href="mailto:tomyeh@potix.com">tomyeh@potix.com</a>
 * @version $Revision: 1.19 $ $Date: 2006/03/09 08:40:17 $
 */

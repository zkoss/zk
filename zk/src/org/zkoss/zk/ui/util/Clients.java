...
public class Clients {
	 ...
	 * see {@link #showToast(String, String, String, int, boolean)}.
	 * default "top_center".
	 * @see Toast#show(String, String, String)
	 * @since 9.0.0
	 */
	public static final void showToast(String msg, String type, String position) {
		Toast.show(msg, type, position);
	}
	 ...
	 * close button on notification message and won't close until user click the button
	 * or duration time up, default false.
	 * @see Toast#show(String, String, String, int, boolean)
	 * @since 9.0.0
	 */
	public static final void showToast(String msg, String type, String position, int duration, boolean closable) {

...
public class AuAppendChild extends AuResponse {
	 ...
	 * @since 5.0.7
	 */
	public AuAppendChild(Component comp, Collection contents) {
	 ...
	 * @since 5.0.7
	 */
	public AuAppendChild(Page page, Collection contents) {
	...
	/*package*/ static Object[] toArray(String uuid, Collection contents) {

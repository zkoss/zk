...
{{IS_NOTE
	...
	History:
		Thu Sep 14 21:49:14     2006, Created by tomyeh@potix.com
}}IS_NOTE
...
public class Link implements Header {
	...
	public String toHTML(Page page) {
		final StringBuffer sb = new StringBuffer(128).append("<link");

...
if (!zk.css3) {
	...
	/**@disable(zkgwt) The shadow effect.
	 */
...
/**@disable(zkgwt) A mask covers the browser window fully.
 */
...
/**@disable(zkgwt) Applies the mask over the specified element to indicate it is busy.
 */ 

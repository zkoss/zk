...
(function (undefined) {
	...
	function _fullScreenZIndex(zi) {
		var presudoFullscreen = null;
		if (document.fullscreenElement) {
			presudoFullscreen = ":fullscreen";
		} else if (document.mozFullScreen) {
			//presudoFullscreen = ":-moz-full-screen";
			...
			presudoFullscreen = ":-webkit-full-screen";
		}
		if (presudoFullscreen) {
			var fsZI = jq.css(jq(presudoFullscreen)[0],"zIndex");

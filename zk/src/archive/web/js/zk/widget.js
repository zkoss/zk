...
new zul.wnd.Window{
  ...
  closable: true
	 ...
	 * <li>If a widget wants to do something when the parent is changed, overrides {@link #beforeParentChange_} 
	 ...
	 * overrides {@link #beforeParentChange_} (which is called by
	 ...
	 * the new widget will be placed before).
	 * @return whether the widget was added successfully. It returns false if the child is always the last child ({@link #lastChild}). 
	 */

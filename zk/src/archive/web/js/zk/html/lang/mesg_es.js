...
mesg.FAILED_TO_RESPONSE = "El servidor fallo al procesar la peticion (request): ";
mesg.UNSUPPORTED_BROWSER = "Explorador (Browser) no compatible, use Internet Explorer o Mozilla, por ejemplo: ";

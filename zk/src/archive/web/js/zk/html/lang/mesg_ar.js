...
mesg.UUID_REQUIRED="يتطلب UUID";
mesg.INVALID_STRUCTURE="شكل غير صحيح: ";
mesg.COMP_OR_UUID_REQUIRED="يتطلب وجود  com او UUID";
mesg.NUMBER_REQUIRED="يتطلب وجود رقم  ";
mesg.INTEGER_REQUIRED="يلزم وجود رقم ";

...
mesg.UUID_REQUIRED = "L'UUID è obbligatorio";
mesg.INVALID_STRUCTURE = "Struttura errata: ";
mesg.COMP_OR_UUID_REQUIRED = "Il componente o il suo UUID sono obbligatori";
mesg.NUMBER_REQUIRED = "Occorre inserire un numero invece di ";
mesg.INTEGER_REQUIRED = "Occorre inserire un numero intero invece di ";
mesg.EMPTY_NOT_ALLOWED = "Campo vuoto non consentito.\nNon è consentito neanche inserire soli spazi.";
mesg.GOTO_ERROR_FIELD = "Arrivato al campo sbagliato";
mesg.PLEASE_WAIT = "Elaborazione in corso...";
mesg.VALUE_NOT_MATCHED = "Occorre selezionare uno dei valori nell'elenco a discesa.";

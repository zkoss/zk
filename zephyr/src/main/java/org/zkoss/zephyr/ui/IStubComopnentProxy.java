...
import org.zkoss.zephyr.ui.util.VolatileIPage;
import org.zkoss.zephyr.ui.util.ZephyrContentRenderer;
import org.zkoss.zephyr.ui.util.ZephyrEventListenerMap;
...
/*package*/ class IStubComponentProxy extends IStubComponent {
	...
	private ZephyrEventListenerMap _zevts;
	...
	protected void renderProperties(ContentRenderer renderer)
			throws IOException {
		final ZephyrContentRenderer zephyrContentRenderer = new ZephyrContentRenderer(
				renderer, _root, this);
		_root.renderProperties(zephyrContentRenderer);
	}

	public void addAction(String name, ActionHandler handler) {
		// lazy init
		if (_zevts == null) {
			_zevts = new ZephyrEventListenerMap(_root.getEventListenerMap());
		}

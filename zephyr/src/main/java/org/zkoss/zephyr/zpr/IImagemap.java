 ...
 * Once you clicked on the area of {@link Imagemap}, you can get the id of the {@link IArea} through {@link org.zkoss.zephyr.action.data.MouseData}.
 *
...
public interface IImagemap extends IImageBase<IImagemap>, IChildable<IImagemap, IArea>, IAnyGroup<IImagemap> {
	...
	/**
	 * Builds an updater of type {@link IImagemap} for {@link org.zkoss.zephyr.ui.UiAgent#smartUpdate(Locator, SmartUpdater)}.

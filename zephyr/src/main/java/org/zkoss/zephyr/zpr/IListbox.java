 ...
 * <p><b>Note:</b> unlike {@link Listbox}, there is no {@code "select"} mold in zephyr API,
...
public interface IListbox extends IMeshElement<IListbox>, IComposite<IMeshComposite>,
	...
	/**
	 * Builds an updater of type {@link IListbox} for {@link org.zkoss.zephyr.ui.UiAgent#smartUpdate(Locator, SmartUpdater)}.

...
public interface IRadio extends ICheckboxBase<IRadio>, IAnyGroup<IRadio> {
	...
	default void renderProperties(ContentRenderer renderer) throws IOException {
		...
		if (group != null) {
			Component fellow = ((ZephyrContentRenderer) renderer).getBinding()
					.getFellow(group);
			if (fellow != null) {
	...
	/**
	 * Builds an updater of type {@link IRadio} for {@link org.zkoss.zephyr.ui.UiAgent#smartUpdate(Locator, SmartUpdater)}.

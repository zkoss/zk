 ...
 *       <tr>
 *          <td>onOK</td>
 *          <td><strong>ActionData</strong>: {@link org.zkoss.zephyr.action.data.KeyData}
 ...
 *       <tr>
 *          <td>onDrop</td>
 *          <td><strong>ActionData</strong>: {@link org.zkoss.zephyr.action.data.DropData}
 *          <br> Represents an action triggered by user’s dragging and dropping a component.</td>
 *       </tr>
 *       <tr>
 *          <td>onSwipe</td>
 *          <td><strong>ActionData</strong>: {@link org.zkoss.zephyr.action.data.SwipeData}
 ...
 *       <tr>
 *          <td>onAfterSize</td>
 *          <td><strong>ActionData</strong>: {@link org.zkoss.zephyr.action.data.AfterSizeData}
...
public interface IHtmlBasedComponent<I extends IHtmlBasedComponent>
	 ...
	 *
	 * <p>Note: in Zephyr, it uses CSS Flex implementation at all,
	...
	default void renderProperties(org.zkoss.zk.ui.sys.ContentRenderer renderer)
		...
		// Zephyr should all use cssflex=true by default

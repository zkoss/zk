 ...
 * </code>
 * </pre>
 * <p>As you can see above, the field {@code "empty"} of the {@link org.zkoss.zephyr.annotation.ActionVariable}
...
public interface ITree extends IMeshElement<ITree>, IComposite<IMeshComposite>,
	...
	/**
	 * Builds an updater of type {@link ITree} for {@link org.zkoss.zephyr.ui.UiAgent#smartUpdate(Locator, SmartUpdater)}.

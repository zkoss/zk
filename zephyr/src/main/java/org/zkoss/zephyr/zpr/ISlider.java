 ...
 *       <tr>
 *          <td>onScroll</td>
 *          <td><strong>ActionData</strong>: {@link org.zkoss.zephyr.action.data.ScrollData}
...
public interface ISlider extends IXulElement<ISlider>, IAnyGroup<ISlider> {
	...
	/**
	 * Builds an updater of type {@link ISlider} for {@link org.zkoss.zephyr.ui.UiAgent#smartUpdate(Locator, SmartUpdater)}.

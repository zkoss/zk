 ...
 *       <tr>
 *          <td>onPaging</td>
 *          <td><strong>ActionData</strong>: {@link org.zkoss.zephyr.action.data.PagingData}
...
public interface IPaging extends IXulElement<IPaging>,
	...
	/**
	 * Builds an updater of type {@link IPaging} for {@link org.zkoss.zephyr.ui.UiAgent#smartUpdate(Locator, SmartUpdater)}.

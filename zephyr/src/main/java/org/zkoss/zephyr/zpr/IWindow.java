 ...
 * <p>By default, a modal window is the same as a highlighted window in zephyr.</p>
...
public interface IWindow<I extends IAnyGroup> extends IXulElement<IWindow<I>>,
	...
	/**
	 * Builds an updater of type {@link IWindow} for {@link org.zkoss.zephyr.ui.UiAgent#smartUpdate(Locator, SmartUpdater)}.

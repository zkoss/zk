...
mesg={};mesg.NOT_FOUND="Bulunamadı : ";mesg.UNSUPPORTED="Henüz Desteklenmiyor : ";mesg.FAILED_TO_SEND="İstek sunucuya yollanamadı.";mesg.FAILED_TO_RESPONSE="Sunucu isteği yerine getiremedi.";mesg.TRY_AGAIN="Try again?";mesg.UNSUPPORTED_BROWSER="Desteklenmeyen tarayıcı: ";mesg.ILLEGAL_RESPONSE="Sunucudan anlaşılmayan cevap döndü. Lütfen yeniden deneyiniz.\n";mesg.FAILED_TO_PROCESS="İşlem gerçekleştirilemedi ";mesg.GOTO_ERROR_FIELD="Yanlış alana gidildi";mesg.PLEASE_WAIT="Bekleyiniz...";mesg.FILE_SIZE="Dosya boyu: ";mesg.KBYTES="KB";mesg.FAILED_TO_LOAD="Yükleme başarısız: ";mesg.FAILED_TO_LOAD_DETAIL="Yoğunluktan kaynaklı problem oluşştu.Lütfen yeniden deneyiniz.";mesg.CAUSE="Neden: ";mesg.LOADING="Bekleyiniz...";
zk.GROUPING=".";
zk.DECIMAL=",";
zk.PERCENT="%";
zk.MINUS="-";
...
msgzul={};msgzul.UNKNOWN_TYPE="Bilinmeyen bileşen(component) tipi: ";msgzul.DATE_REQUIRED="Tarih belirtilmeli. Format: ";msgzul.OUT_OF_RANGE="Aralık aşılıyor";msgzul.NO_AUDIO_SUPPORT="Tarayıcınız dinamik ses bileşenini desteklememektedir.";
zk.$default(msgzul, {

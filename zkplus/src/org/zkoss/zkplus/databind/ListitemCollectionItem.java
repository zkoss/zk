...
/*package*/ class BindingListitemDecorator implements BindingDecorator {
	...
	public Component getComponentCollectionOwner(Component comp) {
		if(comp instanceof Listitem){
			...
			throw new UiException("Unsupported type for BindingListitemDecorator: " + comp);
		}
	}

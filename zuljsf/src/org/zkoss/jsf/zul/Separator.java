...
/**
 * Separator is a JSF component implementation for {@link org.zkoss.zul.Separator}, 
 * 
 ...
 *
 */
public class Separator extends BranchComponent {


	protected Component newComponent(Class use) throws Exception {
		return (Component) (use==null?new org.zkoss.zul.Separator():use.newInstance());
	}

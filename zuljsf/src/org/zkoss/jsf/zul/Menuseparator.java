...
/**
 * Menuseparator is a JSF component implementation for {@link org.zkoss.zul.Menuseparator}, 
 * 
 ...
 *
 */
public class Menuseparator extends BranchComponent {


	protected Component newComponent(Class use) throws Exception {
		return (Component) (use==null?new org.zkoss.zul.Menuseparator():use.newInstance());
	}

...
/**
 * Caption is a JSF component implementation for {@link org.zkoss.zul.Caption}, 
 * 
 ...
 *
 */
public class Caption extends BranchComponent {


	protected Component newComponent(Class use) throws Exception {
		return (Component) (use==null?new org.zkoss.zul.Caption():use.newInstance());
	}

...
/**
 * Menubar is a JSF component implementation for vorg.zkoss.zul.Menubar}, 
 * 
 ...
 *
 */
public class Menubar extends BranchComponent {


	protected Component newComponent(Class use) throws Exception {
		return (Component) (use==null?new org.zkoss.zul.Menubar():use.newInstance());
	}

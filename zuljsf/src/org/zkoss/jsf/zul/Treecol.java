...
/**
 * Treecol is a JSF component implementation for {@link org.zkoss.zul.Treecol}, 
 * 
 ...
 *
 */
public class Treecol extends BranchComponent {


	protected Component newComponent(Class use) throws Exception {
		return (Component) (use==null?new org.zkoss.zul.Treecol():use.newInstance());
	}

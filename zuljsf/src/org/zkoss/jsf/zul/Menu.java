...
/**
 * Menu is a JSF component implementation for {@link org.zkoss.zul.Menu}, 
 * 
 ...
 *
 */
public class Menu extends BranchComponent {


	protected Component newComponent(Class use) throws Exception {
		return (Component) (use==null?new org.zkoss.zul.Menu():use.newInstance());
	}

...
/**
 * Foot is a JSF component implementation for {@link org.zkoss.zul.Foot}, 
 * 
 ...
 *
 */
public class Foot extends BranchComponent {


	protected Component newComponent(Class use) throws Exception {
		return (Component) (use==null?new org.zkoss.zul.Foot():use.newInstance());
	}

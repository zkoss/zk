...
/**
 * Filedownload is a JSF component implementation for {@link org.zkoss.zul.Filedownload}, 
 * 
 ...
 *
 */
public class Filedownload extends BranchComponent {


	protected Component newComponent(Class use) throws Exception {
		return (Component) (use==null?new org.zkoss.zul.Filedownload():use.newInstance());
	}

...
/**
 * Listcell is a JSF component implementation for {@link org.zkoss.zul.Listcell}, 
 * 
 ...
 *
 */
public class Listcell extends BranchComponent {


	protected Component newComponent(Class use) throws Exception {
		return (Component) (use==null?new org.zkoss.zul.Listcell():use.newInstance());
	}

...
/**
 * Div is a JSF component implementation for {@link org.zkoss.zul.Div}, 
 * 
 ...
 *
 */
public class Div extends BranchComponent {


	protected Component newComponent(Class use) throws Exception {
		return (Component) (use==null?new org.zkoss.zul.Div():use.newInstance());
	}

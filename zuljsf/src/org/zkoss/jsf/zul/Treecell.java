...
/**
 * Treecell is a JSF component implementation for {@link org.zkoss.zul.Treecell}, 
 * 
 ...
 *
 */
public class Treecell extends BranchComponent {


	protected Component newComponent(Class use) throws Exception {
		return (Component) (use==null?new org.zkoss.zul.Treecell():use.newInstance());
	}

...
/**
 * The Base implementation of Intbox. This component should be declared
 * nested under {@link org.zkoss.jsf.zul.Page}.
 * 
 * @author Dennis.Chen
 * 
 */
abstract public class BaseIntbox extends BranchInput {

	/**
	 * Override method, add a {@link IntgerFormatConverter} as the default
	...
	protected void afterZULComponentComposed(Component zulcomp) {
		...
		if (converter == null) {
			String format = ((Intbox) zulcomp).getFormat();
			converter = new IntgerFormatConverter(format);

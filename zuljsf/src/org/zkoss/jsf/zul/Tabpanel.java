...
/**
 * Tabpanel is a JSF component implementation for {@link org.zkoss.zul.Tabpanel}, 
 * 
 ...
 *
 */
public class Tabpanel extends BranchComponent {


	protected Component newComponent(Class use) throws Exception {
		return (Component) (use==null?new org.zkoss.zul.Tabpanel():use.newInstance());
	}

...
/**
 * Imagemap is a JSF component implementation for {@link org.zkoss.zul.Imagemap}, 
 * 
 ...
 *
 */
public class Imagemap extends BranchComponent {


	protected Component newComponent(Class use) throws Exception {
		return (Component) (use==null?new org.zkoss.zul.Imagemap():use.newInstance());
	}

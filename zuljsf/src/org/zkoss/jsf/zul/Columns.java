...
/**
 * Columns is a JSF component implementation for {@link org.zkoss.zul.Columns}, 
 * 
 ...
 *
 */
public class Columns extends BranchComponent {


	protected Component newComponent(Class use) throws Exception {
		return (Component) (use==null?new org.zkoss.zul.Columns():use.newInstance());
	}

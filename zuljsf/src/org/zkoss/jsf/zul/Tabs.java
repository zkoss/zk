...
/**
 * Tabs is a JSF component implementation for {@link org.zkoss.zul.Tabs}, 
 * 
 ...
 *
 */
public class Tabs extends BranchComponent {


	protected Component newComponent(Class use) throws Exception {
		return (Component) (use==null?new org.zkoss.zul.Tabs():use.newInstance());
	}

...
/**
 * Treeitem is a JSF component implementation for {@link org.zkoss.zul.Treeitem}, 
 * 
 ...
 *
 */
public class Treeitem extends BranchComponent {


	protected Component newComponent(Class use) throws Exception {
		return (Component) (use==null?new org.zkoss.zul.Treeitem():use.newInstance());
	}

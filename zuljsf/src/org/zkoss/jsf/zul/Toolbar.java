...
/**
 * Toolbar is a JSF component implementation for {@link org.zkoss.zul.Toolbar}, 
 * 
 ...
 *
 */
public class Toolbar extends BranchComponent {


	protected Component newComponent(Class use) throws Exception {
		return (Component) (use==null?new org.zkoss.zul.Toolbar():use.newInstance());
	}

...
/**
 * Tabbox is a JSF component implementation for {@link org.zkoss.zul.Tabbox}, 
 * 
 ...
 *
 */
public class Tabbox extends BranchComponent {


	protected Component newComponent(Class use) throws Exception {
		return (Component) (use==null?new org.zkoss.zul.Tabbox():use.newInstance());
	}

...
/**
 * Treecols is a JSF component implementation for {@link org.zkoss.zul.Treecols}, 
 * 
 ...
 *
 */
public class Treecols extends BranchComponent {


	protected Component newComponent(Class use) throws Exception {
		return (Component) (use==null?new org.zkoss.zul.Treecols():use.newInstance());
	}

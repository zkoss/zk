...
/**
 * Progressmeter is a JSF component implementation for {@link org.zkoss.zul.Progressmeter}, 
 * 
 ...
 *
 */
public class Progressmeter extends BranchComponent {


	protected Component newComponent(Class use) throws Exception {
		return (Component) (use==null?new org.zkoss.zul.Progressmeter():use.newInstance());
	}

...
/**
 * Treerow is a JSF component implementation for {@link org.zkoss.zul.Treerow}, 
 * 
 ...
 *
 */
public class Treerow extends BranchComponent {


	protected Component newComponent(Class use) throws Exception {
		return (Component) (use==null?new org.zkoss.zul.Treerow():use.newInstance());
	}

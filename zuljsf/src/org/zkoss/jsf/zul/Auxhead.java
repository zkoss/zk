...
/**
 * Window is a JSF component implementation for {@link org.zkoss.zul.Auxhead}, 
 * 
 ...
 *
 */
public class Auxhead extends BranchComponent {


	protected Component newComponent(Class use) throws Exception {
		return (Component) (use==null?new org.zkoss.zul.Auxhead():use.newInstance());
	}

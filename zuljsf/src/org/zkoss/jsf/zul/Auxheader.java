...
/**
 * Window is a JSF component implementation for {@link org.zkoss.zul.Auxheader}, 
 * 
 ...
 *
 */
public class Auxheader extends BranchComponent {


	protected Component newComponent(Class use) throws Exception {
		return (Component) (use==null?new org.zkoss.zul.Auxheader():use.newInstance());
	}

...
/**
 * Treefoot is a JSF component implementation for {@link org.zkoss.zul.Treefoot}, 
 * 
 ...
 *
 */
public class Treefoot extends BranchComponent {


	protected Component newComponent(Class use) throws Exception {
		return (Component) (use==null?new org.zkoss.zul.Treefoot():use.newInstance());
	}

...
/**
 * Vbox is a JSF component implementation for {@link org.zkoss.zul.Vbox}, 
 * 
 ...
 *
 */
public class Vbox extends BranchComponent {


	protected Component newComponent(Class use) throws Exception {
		return (Component) (use==null?new org.zkoss.zul.Vbox():use.newInstance());
	}

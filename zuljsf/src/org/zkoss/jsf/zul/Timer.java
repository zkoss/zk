...
/**
 * Timer is a JSF component implementation for {@link org.zkoss.zul.Timer}, 
 * 
 ...
 *
 */
public class Timer extends BranchComponent {


	protected Component newComponent(Class use) throws Exception {
		return (Component) (use==null?new org.zkoss.zul.Timer():use.newInstance());
	}

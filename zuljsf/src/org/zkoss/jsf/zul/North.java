...
/**
 * Window is a JSF component implementation for {@code org.zkoss.zkex.zul.North}, 
 * 
 ...
 *
 */
public class North extends BranchComponent {


	protected Component newComponent(Class use) throws Exception {
		return (Component) (use==null?new org.zkoss.zkex.zul.North():use.newInstance());
	}

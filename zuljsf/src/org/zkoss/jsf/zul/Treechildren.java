...
/**
 * Treechildren is a JSF component implementation for {@link org.zkoss.zul.Treechildren}, 
 * 
 ...
 *
 */
public class Treechildren extends BranchComponent {


	protected Component newComponent(Class use) throws Exception {
		return (Component) (use==null?new org.zkoss.zul.Treechildren():use.newInstance());
	}

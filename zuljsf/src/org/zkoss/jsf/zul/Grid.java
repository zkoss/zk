...
/**
 * Grid is a JSF component implementation for {@link org.zkoss.zul.Grid}, 
 * 
 ...
 *
 */
public class Grid extends BranchComponent {


	protected Component newComponent(Class use) throws Exception {
		return (Component) (use==null?new org.zkoss.zul.Grid():use.newInstance());
	}

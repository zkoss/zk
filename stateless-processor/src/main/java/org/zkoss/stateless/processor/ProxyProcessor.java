 ...
 * delegation to {@code org.zkoss.stateless.processor.Processor}.
 */
@Metainf.Service
public final class ProxyProcessor implements Processor {
	private static final String DELEGATE_CLASS = "org.zkoss.stateless.processor.Processor";
	...
	private static Processor createDefaultDelegate() {
		return new org.zkoss.stateless.processor.Processor();
	}

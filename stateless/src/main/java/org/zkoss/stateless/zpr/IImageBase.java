...
public interface IImageBase<I extends IImageBase> extends IXulElement<I> {
	 ...
	 * ZK will try to locate the image file called /stateless/ZK-Logo_de_DE.gif. If it is not found, it will try /stateless/ZK-Logo_de.gif and finally /stateless/ZK-Logo.gif.
	 *
	 * <p>

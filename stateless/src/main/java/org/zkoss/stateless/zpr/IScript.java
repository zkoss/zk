...
public interface IScript extends IComponent<IScript> {
	...
	default void renderProperties(ContentRenderer renderer) throws IOException {
		...
		if (_src != null) {
			...
			if (rc != null && rc.perm != null) {
				...
				if (renderer instanceof StatelessContentRenderer) {
					final StatelessContentRenderer zcr = (StatelessContentRenderer) renderer;
	...
	/**
	 * Builds an updater of type {@link IScript} for {@link UiAgent#smartUpdate(Locator, SmartUpdater)}.

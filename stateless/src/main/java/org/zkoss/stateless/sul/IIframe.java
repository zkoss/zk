...
import org.zkoss.stateless.action.data.URIData;
 ...
 *       <tr>
 *          <td>onURIChange</td>
 *          <td><strong>ActionData</strong>: {@link URIData}
...
public interface IIframe extends IHtmlBasedComponent<IIframe>, IAnyGroup<IIframe> {
	...
	/**
	 * Builds an updater of type {@link IIframe} for {@link UiAgent#smartUpdate(Locator, SmartUpdater)}.

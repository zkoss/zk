...
/**
 * A getter method handle for {@link Component} to {@link IComponent}.
 *
 * @author jumperchen
 */
	...
	public Object invoke(Object self, Method method, Method proceed,
		...
		try {
			...
			if (Modifier.isPublic(method.getModifiers())) {
				...
				} else if (method.getAnnotation(StatelessOnly.class) != null) {
					return proceed != null ? // invoke default method if any
							proceed.invoke(self, args) :
							ActionHandler.DEFAULT_VALUES.getOrDefault(
									method.getReturnType(),
									null); // ignore for Stateless internal use method
				}

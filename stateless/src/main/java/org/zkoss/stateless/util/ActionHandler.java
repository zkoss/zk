...
public interface ActionHandler extends Serializable {
	 ...
	 * {@code "org.zkoss.stateless.util.ActionHandler.CACHE_SIZE"} in ZK library property</p>
	 */
	int CACHE_SIZE = Library.getIntProperty("org.zkoss.stateless.util.ActionHandler.CACHE_SIZE", 1000);

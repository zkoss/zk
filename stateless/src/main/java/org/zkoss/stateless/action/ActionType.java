...
public interface ActionType {
	...
	@Action(type = Events.ON_ACROSS_PAGE)
	interface OnAcrossPage6<A, B, C, D, E, F> extends ActionHandler6<A, B, C, D, E, F> {}

	@Action(type = Events.ON_ACROSS_PAGE)
	interface OnAcrossPage7<A, B, C, D, E, F, G> extends ActionHandler7<A, B, C, D, E, F, G> {}

	@Action(type = Events.ON_ACROSS_PAGE)
	interface OnAcrossPage8<A, B, C, D, E, F, G, H> extends ActionHandler8<A, B, C, D, E, F, G, H> {}

	@Action(type = Events.ON_ACROSS_PAGE)
	interface OnAcrossPage9<A, B, C, D, E, F, G, H, I> extends ActionHandler9<A, B, C, D, E, F, G, H, I> {}

 ...
 * @author jameschu
 */
public class B95_ZK_3563VM implements Serializable {
	private B95_ZK_3563Object paramObject = new B95_ZK_3563Object();
	private boolean template = true;
	List<String> items = new ArrayList<String>();

	public B95_ZK_3563VM() {
		items.add("A");
	}
	...
	public B95_ZK_3563Object getParamObject() {
		return paramObject;
	}

/* OuterBinderGlobalCommandModel.java
	Purpose:
 ...
 * @author jameschu
 */
public class OuterBinderGlobalCommandModel {
	@GlobalCommand
	public void globalCmdOuter(@BindingParam("arg1") int arg1, @BindingParam("arg2") String arg2) {
		Clients.log("GlobalCommand called > arg1: " + arg1 + ", arg2: " + arg2);
	}

	@GlobalCommand
	public void globalCmdOuterMyQueue(@BindingParam("arg1") int arg1, @BindingParam("arg2") String arg2) {
		Clients.log("GlobalCommand called > arg1: " + arg1 + ", arg2: " + arg2);
	}

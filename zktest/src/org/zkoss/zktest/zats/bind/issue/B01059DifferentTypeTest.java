...
public class B01059DifferentTypeTest extends ZATSTestCase {
	...
	public void test() {
		...
		try {
			...
			assertTrue(e.getCause().getCause().toString().contains("UiException: Property 'value1' not writable"));
		}
		ib2.type("2");
		...
		try {
			...
			assertTrue(e.getCause().getCause().toString().contains("UiException: Property 'value3' not writable"));
		}

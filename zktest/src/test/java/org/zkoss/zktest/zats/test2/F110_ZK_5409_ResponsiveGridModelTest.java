/* F110_ZK_5409_ResponsiveGridModelTest.java
...
public class F110_ZK_5409_ResponsiveGridModelTest extends WebDriverTestCase {
	...
	public void testListModelStacking() {
		connect("/test2/F110-ZK-5409-responsive-grid-model.zul");
		waitResponse();

/* F103_ZK_5265GeneratorTest.java
...
@ForkJVMTestOnly
public class F103_ZK_5265GeneratorTest extends WebDriverTestCase {
	@RegisterExtension
	public static final ExternalZkXml CONFIG = new ExternalZkXml("/test2/F103-ZK-5265Generator.xml");

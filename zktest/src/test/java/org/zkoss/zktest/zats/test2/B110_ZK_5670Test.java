...
@ForkJVMTestOnly
public class B110_ZK_5670Test extends WebDriverTestCase {
    @RegisterExtension
    public static final ExternalZkXml CONFIG = new ExternalZkXml("/test2/B110-ZK-5670.xml");

    @Test
    public void testEmbeddedProgressboxPosition() {
        connect("/test2/B110-ZK-5670Embedded.zhtml");
        waitResponse();
        sleep(2000);
    ...
    public void testNonEmbeddedProgressboxPosition() {
        connect("/test2/B110-ZK-5670.zul");
        waitResponse();
        String progPos = getEval("typeof zk !== 'undefined' && zk.progPos ? zk.progPos : 'not set'");
        assertEquals("center, center", progPos);
    }

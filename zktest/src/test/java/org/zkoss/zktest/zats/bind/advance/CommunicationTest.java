...
public class CommunicationTest extends ZATSTestCase {
	...
	public void composerToViewModelTest() {
		...
		Assertions.assertEquals("onClick: cmd1", desktop.query("#l2").as(Label.class).getValue());
	}
	...
	public void viewModelToComposerTest() {
		...
		Assertions.assertEquals("onGlobalCommand: cmd2", desktop.query("#l1").as(Label.class).getValue());
	}
}

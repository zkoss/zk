/* F110_ZK_6099ReducedMotionTest.java
 ...
 *  F110-ZK-6099.zul page, asserting the computed animation is disabled on both paths.
 */
public class F110_ZK_6099ReducedMotionTest extends WebDriverTestCase {
	@Override
	...
	@Test
	public void test() {
		connect("/test2/F110-ZK-6099.zul");
		waitResponse();

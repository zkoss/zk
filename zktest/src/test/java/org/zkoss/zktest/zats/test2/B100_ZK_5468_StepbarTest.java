/* B100_ZK_5468_StepbarTest.java
	...
	History:
		2:46 PM 2023/7/21, Created by jumperchen
 ...
 * @author jumperchen
 */
public class B100_ZK_5468_StepbarTest extends WebDriverTestCase {
	@Test
	public void testInsertBefore() {
		...
		int index = 0;
		for (Iterator<JQuery> it = jq(".z-step-title").iterator(); it.hasNext(); ) {

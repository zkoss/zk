/* F110_ZK_6086CodeeditorCspTest.java
 ...
 */
@ForkJVMTestOnly
public class F110_ZK_6086CodeeditorCspTest extends WebDriverTestCase {
	@RegisterExtension
	public static final ExternalZkXml CONFIG = new ExternalZkXml("/test2/F110-ZK-6086-Codeeditor-csp.xml");
	private static final String PAGE = "/test2/F110-ZK-6086-Codeeditor-csp.zul";

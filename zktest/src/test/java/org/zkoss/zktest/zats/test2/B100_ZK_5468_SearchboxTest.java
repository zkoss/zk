/* B100_ZK_5468_SearchboxTest.java
	...
	History:
		12:41 PM 2023/7/21, Created by jumperchen
 ...
 * @author jumperchen
 */
public class B100_ZK_5468_SearchboxTest extends WebDriverTestCase {
	@Test
	public void testInsertBefore() {
		connect();

		click(jq(".z-searchbox-placeholder"));
		waitResponse(true);

		String[] result = {"0 - aaa0", "1 - aaa1", "2 - aaa2"};
		int index = 0;
		for (Iterator<JQuery> it = jq(".z-searchbox-item").iterator(); it.hasNext(); ) {

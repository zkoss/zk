/* B100_ZK_5468_RadiogroupTest.java
	...
	History:
		2:38 PM 2023/7/21, Created by jumperchen
 ...
 * @author jumperchen
 */
public class B100_ZK_5468_RadiogroupTest extends WebDriverTestCase {
	@Test
	public void testInsertBefore() {
		...
		int index = 0;
		for (Iterator<JQuery> it = jq(".z-radio-content").iterator(); it.hasNext(); ) {

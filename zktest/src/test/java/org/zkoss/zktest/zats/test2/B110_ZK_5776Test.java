...
@ForkJVMTestOnly
public class B110_ZK_5776Test extends WebDriverTestCase {
    @RegisterExtension
    public static final ExternalZkXml CONFIG = new ExternalZkXml("/test2/B110-ZK-5776.xml");

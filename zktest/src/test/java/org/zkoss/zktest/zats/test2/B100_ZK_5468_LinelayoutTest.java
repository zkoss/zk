/* B100_ZK_5468_LinelayoutTest.java
	...
	History:
		2:34 PM 2023/7/21, Created by jumperchen
 ...
 * @author jumperchen
 */
public class B100_ZK_5468_LinelayoutTest extends WebDriverTestCase {
	@Test
	public void testInsertBefore() {
		...
		int index = 0;
		for (Iterator<JQuery> it = jq(".z-lineitem .z-label").iterator(); it.hasNext(); ) {

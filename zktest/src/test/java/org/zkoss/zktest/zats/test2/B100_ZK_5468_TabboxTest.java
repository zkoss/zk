/* B100_ZK_5468_TabboxTest.java
	...
	History:
		2:47 PM 2023/7/21, Created by jumperchen
 ...
 * @author jumperchen
 */
public class B100_ZK_5468_TabboxTest extends WebDriverTestCase {
	@Test
	public void testInsertBefore() {
		...
		int index = 0;
		for (Iterator<JQuery> it = jq(".z-tab-content").iterator(); it.hasNext(); ) {

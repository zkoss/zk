/* B100_ZK_5468_GridTest.java
	...
	History:
		2:21 PM 2023/7/21, Created by jumperchen
 ...
 * @author jumperchen
 */
public class F102_ZK_5504_GridTest extends WebDriverTestCase {
	...
	public void testInsertBefore() {
		...
		for (Iterator<JQuery> it = jq(".z-grid").iterator(); it.hasNext(); ) {
			int index = 0;
			JQuery grid = it.next();
			for (Iterator<JQuery> rowsIt = grid.find(".z-row").iterator(); rowsIt.hasNext(); ) {

...
@Tag("diagnostic")
public class F110_ZK_5409_DeepInspect extends WebDriverTestCase {

	@Test
	public void inspectGroupGrid() {
		try { connect("/test2/F110-ZK-5409-responsive-grid-group.zul"); } catch (Throwable ignored) {}

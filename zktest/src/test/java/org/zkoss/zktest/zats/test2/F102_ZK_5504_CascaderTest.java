/* F102_ZK_5504_CascaderTest.java
	...
	History:
		05:39 PM 2025/4/17, Created by jumperchen
 ...
 * @author jumperchen
 */
public class F102_ZK_5504_CascaderTest extends WebDriverTestCase {
	...
	public void testInsertBefore() {
		...
		int index = 0;
		for (Iterator<JQuery> it = jq(".z-cascader-item").iterator(); it.hasNext(); ) {

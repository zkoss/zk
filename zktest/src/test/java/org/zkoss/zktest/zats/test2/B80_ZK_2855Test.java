...
public class B80_ZK_2855Test extends ZutiBasicTestCase {
	...
	public void test() {
		...
		Assertions.assertEquals("include 1", label1.getValue());
		Label label2 = host1.getLastChild().getFirstChild().as(Label.class);
		Assertions.assertEquals("include 2", label2.getValue());
		...
		Assertions.assertEquals("include 1", label3.getValue());
		...
		Assertions.assertEquals("include 2", label4.getValue());
		...
		Assertions.assertEquals("include 1", label5.getValue());
		Label label6 = host4.getLastChild().getFirstChild().as(Label.class);
		Assertions.assertEquals("include 1", label6.getValue());

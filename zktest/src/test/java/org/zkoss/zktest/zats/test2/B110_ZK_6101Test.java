 ...
 */
@ForkJVMTestOnly
public class B110_ZK_6101Test extends WebDriverTestCase {
	@RegisterExtension
	public static final ExternalZkXml CONFIG = new ExternalZkXml(B110_ZK_6101Test.class);

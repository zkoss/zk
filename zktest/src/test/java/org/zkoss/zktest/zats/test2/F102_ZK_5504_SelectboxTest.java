/* B100_ZK_5468_SelectboxTest.java
	...
	History:
		2:40 PM 2023/7/21, Created by jumperchen
 ...
 * @author jumperchen
 */
public class F102_ZK_5504_SelectboxTest extends WebDriverTestCase {
	@Test
	public void testInsertBefore() {
		...
		int index = 0;
		for (Iterator<JQuery> it = jq(".z-selectbox option").iterator(); it.hasNext(); ) {

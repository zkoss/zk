/* B102_ZK_5505Test.java
        ...
        History:
                Thu Apr 24 18:16:18 CST 2025, Created by jamson
...
public class B102_ZK_5505Test extends WebDriverTestCase {
    ...
    public void test() {
        ...
        Assertions.assertTrue(isFocusOnListbox());
        Assertions.assertFalse(isFocusOnBody());
        getActions().sendKeys(Keys.TAB).perform();
        Assertions.assertFalse(isFocusOnListbox());
        Assertions.assertTrue(isFocusOnBody());
    }

    private boolean isFocusOnListbox() {
        return jq("@listbox").attr("id").equals(getEval("document.activeElement.id"))

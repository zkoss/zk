/* F110_ZK_5409_ResponsiveGridChildTest.java
...
public class F110_ZK_5409_ResponsiveGridChildTest extends WebDriverTestCase {
	...
	public void testFooterStacking() {
		connect("/test2/F110-ZK-5409-responsive-grid-child.zul");
		waitResponse();
	...
	public void testGroupCollapseStacking() {
		connect("/test2/F110-ZK-5409-responsive-grid-group.zul");
		waitResponse();
	...
	public void testOddEvenStripeStacking() {
		connect("/test2/F110-ZK-5409-responsive-grid-event.zul");
		waitResponse();
	...
	public void testCellContentStacking() {
		connect("/test2/F110-ZK-5409-responsive-grid-cell.zul");
		waitResponse();

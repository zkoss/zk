/* BasicReferenceBindingTest.java
	Purpose:
 ...
 * @author jameschu
 */
public class BasicReferenceBindingTest extends ZATSTestCase {
	@Test
	public void test() {
		DesktopAgent desktopAgent = connect();
		//[Step 1]
		Label l1 = desktopAgent.query("#l1").as(Label.class);
		ComponentAgent ib1 = desktopAgent.query("#ib1");
		...
		ComponentAgent tb2Agent = desktopAgent.query("#tb2");
		...
		ComponentAgent tb3Agent = desktopAgent.query("#tb3");
		...
		//[Step 3]
		ComponentAgent appendBtn = desktopAgent.query("#appendBtn");
		appendBtn.click();
		...
		//[Step 4]
		desktopAgent.query("#updateBtn").click();

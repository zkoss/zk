...
public class F102_ZK_5600VM {
	...
	@Command
	public void expectable() throws Exception {
		throw new F102_ZK_5600Exception();
	}

	@Command
	public void unexpectable() throws Exception {
		throw new RuntimeException("unexpectable exception");
	}
}

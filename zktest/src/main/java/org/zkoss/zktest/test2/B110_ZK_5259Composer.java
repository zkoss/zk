...
public class B110_ZK_5259Composer extends SelectorComposer<Component> {
    @Listen(Events.ON_CLICK + "=#btn")
	public void doBtnClick() {
		Component rootComponent = Executions.getCurrent().createComponents("B110-ZK-5259-1.zul", null)[0];
